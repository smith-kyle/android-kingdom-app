...
public class QuestSlidePageFragment extends Fragment {
    ...
    public static QuestSlidePageFragment newInstance(int questID, String questName, int giverID, String giverName, String giverImage){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Picasso.with(getActivity()).load(mGiverImage).into(mGiverImageView);
